...
public class selectkudoSingleTest1 extends Base{
...
//		}
	...
	a.kudostype("Exceptional Work");
		a.comments().sendKeys("Thank you for providing quick solution to my new laptop issues");
		Thread.sleep(1000);
		a.send().click();
	
		log1.info("kudo successfully sent");
